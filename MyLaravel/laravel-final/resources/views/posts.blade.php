{{-- berfungsi sama seperti var_dump  php --}}
{{-- @dd($posts) --}}
...
@section('container')
   ...
   <div class="row justify-content-center mb-3">
        <div class="col-md-6">
            <form action="/posts">
            {{-- digunakan untuk mencari di category --}}
            @if (request('category'))
   ...
   @if ($posts->count())
        <div class="card mb-3">
            ...
            <p class="card-text">
                {{-- diffForHumans agar mudah dibaca tanggal ini dibiuat dengan library carbon yang sudah ada di laravel --}}
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"> <a class="text-white text-decoration-none" href="/posts?category={{ $post->category->slug }}">{{ $post->category->name }}</a> </div>
                        {{-- Image Blog All --}}
                        @if ($post->image)
    ...
    {{-- tobol selanjutnya darilaravel default tailwinds --}}
