...
class DashboardPostController extends Controller
{
    ...
    {
       // untuk melihat dimana file image disimpan
       // ddd($request);
       // percobaan memasukana ke databse
    ...
    //    membatasi limit
    //  https://laravel.com/docs/8.x/helpers#strings
    // strip_tags = agar tag htmlnya hilang
    ...
    {
        // hanya menampilkan tampilan update
    ...
    public function update(Request $request, Post $post)
    {
        ...
        $validatedData = $request->validate(($rules));
         ...
         // cek gambar ada kaga 
        if($request->file('image')) {
            // menghapus foto  lama setelah di update
            if($request->oldImage){
